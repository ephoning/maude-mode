...
(defcustom maude-command "/Volumes/Data/maude/maude-2.6/maude/maude.intelDarwin"
  "Path to the maude executable.  Use \\[run-maude] to run maude."
  :type 'file
  :group 'maude)

(defcustom maude-command-options (list "-ansi-color" "-no-wrap")
...
(easy-menu-define maude-mode-menu maude-mode-map
  ...
  '("Maude"
    ...
    ["Run Full Maude" run-full-maude t]
